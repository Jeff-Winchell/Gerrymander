Select Voting_District_Neighbor.State_FIPS,
	...
	Into Congressional_District_Border_Precinct
	From Voting_District_Neighbor
			Inner Join
		Voting_District_Congressional_District A1
			...
			Inner Join
		Voting_District_Congressional_District A2
...
Go
Alter Table Congressional_District_Border_Precinct 
